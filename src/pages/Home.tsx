...
export function Home() {
  ...
  return (
      <div className="flex w-full h-screen relaive p-6 sm:p-10 md:px-10 bg-darkblack text-offwhite items-center justify-center">
        <motion.div
      initial={{ opacity: 0, scale: 0.5 }}
      animate={{ opacity: 1, scale: 1 }}
      transition={{ duration: 1, ease: 'easeOut' }}
    >
        <div className="flex flex-col p-4 py-40 md:px-20 md:py-40 lg:p-40 border border-offwhite/50 rounded-xl w-full justify-center gap-10">
          <h1 className="text-9xl text-wrap lg:text-[200px] text-offwhite text-roboto font-medium font-stretch-ultra-condensed text-center md:text-nowrap underline underline-offset-2 decoration-lime mb-0 selection:bg-lime selection:text-darkblack">
            DIPANWITA BALA
          </h1>
        ...
        <div className="flex justify-between text-lg font-medium">
          ...
          <div className="w-20 md:w-35 flex gap-10 cursor-pointer absolute left-15 top-80 md:left-30 md:top-95 group -rotate-10 transform hover:scale-110 hover:rotate-5 text-pink-600" onClick={() => navigate('/about')}>
          ...
          <div className="w-20 md:w-35 md:h-35 flex gap-10 cursor-pointer absolute bottom-20 right-40 md:top-115 md:right-40 transform group hover:scale-110 hover:rotate-5 text-orange" onClick={() => navigate('/contact')}>
